...
class Trainer(DefaultTrainer):
    ...
    def build_optimizer(cls, cfg, model):
        ...
        # ===================================================================
        unloaded_params = [
            'detection_transformer.point_embed.weight',
            'detection_transformer.ctrl_point_text.0.weight',
            'detection_transformer.ctrl_point_text.0.bias',
            'detection_transformer.ctrl_point_text.1.weight',
            'detection_transformer.ctrl_point_text.1.bias',
            'detection_transformer.ctrl_point_text.2.weight',
            'detection_transformer.ctrl_point_text.2.bias',
            'detection_transformer.ctrl_point_text.3.weight',
            'detection_transformer.ctrl_point_text.3.bias',
            'detection_transformer.ctrl_point_text.4.weight',
            'detection_transformer.ctrl_point_text.4.bias',
            'detection_transformer.ctrl_point_text.5.weight',
            'detection_transformer.ctrl_point_text.5.bias'
        ]
        # ===================================================================
