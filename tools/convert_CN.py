...
from utils.bezier_utils import polygon_to_bezier_pts
from utils.utils_Chinese import word_to_index_list, index_list_to_word
    ...
    for item in original_annotations:
        ...
        for group in item['groups']:
            for word in group:
                ...
                bbox = calculate_bounding_box(polys, img.shape[1], img.shape[0])
...
def main():
    ...
    parser.add_argument('--input_json', type=str, default='datasets/new_rumsey/tc25synth_train.json', help='Input JSON file path')
    parser.add_argument('--output_json', type=str,default='datasets/voc148/tc25synth_train_5461voc.json', help='Output JSON file path')
    parser.add_argument('--output_image_id_json', type=str,default='datasets/voc148/tc25synth_train_5461voc_image_id.json', help='Output JSON file path')
