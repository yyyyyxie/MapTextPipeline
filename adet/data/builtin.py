...
_PREDEFINED_SPLITS_TEXT = {
    ...
    "rumsey_train": ("rumsey/train", "rumsey/rumsey_train_37voc.json"),
    ...
    "rumsey_train_96voc": ("rumsey/train", "rumsey/rumsey_train_96voc.json"),
    "textocr1_96voc": ("textocr/train_images", "textocr/textocr_train_96voc_25len_1.json"),
    "textocr2_96voc": ("textocr/train_images", "textocr/textocr_train_96voc_25len_2.json"),


    # 148 voc_size
    # "textocr1_148voc": ("textocr/train_images", "textocr/train_37voc_1.json"),
    # "textocr2_148voc": ("textocr/train_images", "textocr/train_37voc_2.json"),
    "syntext1_148voc": ("syntext1/images", "voc148/syntext1_train_148voc.json"),
    "syntext2_148voc": ("syntext2/images", "voc148/syntext2_train_148voc.json"),
    "totaltext_train_148voc": ("totaltext/train_images", "voc148/tt_train_148voc.json"),
    "mlt_148voc": ("mlt2017/images", "voc148/mlt2017_train_148voc.json"),
    "ic13_train_148voc": ("ic13/train_images", "voc148/ic13_train_148voc.json"),
    "ic15_train_148voc": ("ic15/train_images", "voc148/ic15_train_148voc.json"),
    "rumsey_train_148voc": ("", "voc148/rumsey_train_148voc.json"),
    "sample_train_148voc": ("sample", "sample/sample_voc148_train.json"),
    "textocr1_148voc": ("textocr/train_images", "voc148/textocr_train_148voc_1.json"),
    "textocr2_148voc": ("textocr/train_images", "voc148/textocr_train_148voc_2.json"),
    "ign_train_148voc": ("", "voc148/ign_train_voc148.json"),
    ...
    "rumsey_val_37voc": ("rumsey/val", "rumsey/rumsey_val_37voc.json"),
    "rumsey_val_148voc": ("", "voc148/rumsey_val_148voc.json"),
    "rumsey_test_148voc": ("", "voc148/rumsey_test_148voc.json"),
    "ign_val_148voc": ("", "voc148/ign_val_voc148.json"), 
    "ign_test_148voc": ("", "voc148/ign_test_voc148.json"), 
